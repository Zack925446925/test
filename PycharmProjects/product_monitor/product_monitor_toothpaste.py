...
def tmget(filePath2,name, zdname, keyname): #filePath2为文件路径，name为文件名，zdname为"字段"的值，keyname为"对应关键字"的值
    ...
    try:
        ...
        #wb.save(r'E:\01复硕正态\08项目\03男士面霜\02成品数据\第二版/天猫/元数据1/' + name)
...
def jdget(filePath2, name, zdname, keyname):
    ...
    try:
        ...
        #wb.save(r'E:\01复硕正态\08项目\03男士面霜\02成品数据\第二版/京东/元数据1/' + name)
    except Exception as e:
        print(e)
...
#filePath1 = r'E:/01复硕正态/08项目/04中华项目监测/01测试数据/01旗舰店数据/2018-3-31旗舰店数据/'
#filePath2 = r'E:/01复硕正态/08项目/04中华项目监测/02成品数据/旗舰店数据/2018-3-14/'
#filePath3 = r'E:/01复硕正态/08项目/04中华项目监测/02成品数据/旗舰店数据/2018-3-31/'
#filePath4 = r'E:\01复硕正态\08项目\04中华项目监测\02成品数据\旗舰店数据/'

filePath1 = r'G:/01复硕正态/08项目/04中华项目监测/01测试数据/01旗舰店数据/2018-4-13旗舰店数据/'
filePath2 = r'G:/01复硕正态/08项目/04中华项目监测/02成品数据/旗舰店数据/2018-3-31/'
filePath3 = r'G:/01复硕正态/08项目/04中华项目监测/02成品数据/旗舰店数据/2018-4-13/'
filePath4 = r'G:\01复硕正态\08项目\04中华项目监测\02成品数据\旗舰店数据/'
